...
export const BODIES: CelestialBody[] = [
  {
    ...
    color: "#9e522f",
    atmosphere: "#e39959",
    description: "A rust-gold world whose orbital elevators feed the oldest yards in the system.",
  },
  {
    id: "morrow",
    name: "Morrow",
    ...
    color: "#6b7e83",
    atmosphere: "#9cc4c4",
    description: "A fractured moon, rich in water ice and deep blue shadow.",
  },
  {
    id: "brindle",
    name: "Brindle",
    ...
    gravity: 250000,
    color: "#625749",
    description: "An old nickel body cut through with tunnels and navigation lamps.",
  },
];
...
export const STATIONS: Station[] = [
  {
    ...
    description: "A warm ring of markets, bunkrooms, and shift-change traffic above Cinder.",
  },
  {
    id: "sinter",
    ...
    description: "Kilns and radiators burn copper-bright against Cinder’s night side.",
  },
  {
    id: "anvil",
  ...
  },
  {
    ...
    services: ["contracts", "fuel"],
    description: "Ore cages emerge from Brindle’s shadow on slow industrial winches.",
  },
  {
    id: "bluehour",
    name: "Bluehour Depot",
...
export const CONTRACTS: ContractDefinition[] = [
  ...
  { id: "parts-deepwell", title: "Crusher bearings", kind: "standard", origin: "sinter", destination: "deepwell", cargo: "components", quantity: 2, baseReward: 2650, minReputation: 0, description: "Machine parts for Brindle’s aging extraction drums." },
